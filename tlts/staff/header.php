        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Lists">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            <li>
             ...
             <li>
              <a href="Borrowedlist.php">Borrowed List</a>
            </li>
      <li>
              <a href="lreser.php">Reservation List</a>
            </li>
			       <li>
              <a href="record.php">Record List</a>
            </li> 
            <li>
              <a href="cemetery_list.php">Cemetery List</a>
            </li>
          </ul>
        </li>
