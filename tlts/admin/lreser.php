...
<div class  = "col-lg-12">
<div class = "card mb-3">
<div class = "card-header"><center><h4>Reservation Lists</center></h4></div>
<div class = "card-body">
<?php
 
 $result =$mysqli->query("SELECT reservation_id, user_id, equipment_id, dates, status, purpose FROM reservation where status ='pending' ORDER BY reservation_id ASC");  
 ?>
